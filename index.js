...
import { heightPercentageToDP } from '../../src/helpers/ScailingScreen';
import OrientationHelper from '../../src/helpers/OrientationHelper';
...
const styles = StyleSheet.create({
  ...
  infoView: {
    height: OrientationHelper.isTablet()
